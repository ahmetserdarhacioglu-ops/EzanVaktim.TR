...
- 🔒 CSRF korumalı JSON API uçları
- 📱 Mobil uyumlu, hafif arayüz (Leaflet harita dışında dış bağımlılık yok)
...
- **PHP 8.1+**
- PHP eklentileri: `mbstring`, `iconv`, `json`, `openssl`
- `storage/cache` ve `storage/logs` klasörlerine yazma izni
